...
if __name__ == "__main__":
    ...
    for i, (train_dataset, val_dataset) in enumerate(k_fold.split(dataset)):
        ...
        # 2022-09-28-22-21-39.pt --> v1
        # 2022-09-28-22-20-55.pt --> v2
        trainer.load_state_dict(
            os.path.join(PARAMS['PARAM_PATH'], f'2022-09-28-22-21-39.pt'))
...
# 2022-09-28-22-21-39.pt --> v1
# loss: 0.436948, accuracy: 91.8%
# tensor([[2959,  377],
#         [ 250, 4094]], device='cuda:1')
# Area under ROC: 97.4%